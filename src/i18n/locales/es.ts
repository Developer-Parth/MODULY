...
export const es: TranslationDict = {
  ...
  "onboarding": {
    ...
    "finishing": {
      "title": "¡Todo listo!",
      "subtitle": "MODULY está listo. Redirigiéndote a la pantalla de inicio de sesión..."
    },
    "search": {
    ...
    "buttons": {
      "next": "Siguiente",
      "back": "Atrás",
      "startUsing": "Empezar a usar MODULY"
    }
  },
  "battery": {
    "title": "Batería",
