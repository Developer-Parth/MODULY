...
export const fr: TranslationDict = {
  ...
  "onboarding": {
    ...
    "finishing": {
      ...
      "subtitle": "MODULY est prêt. Redirection vers l’écran de connexion..."
    },
    "search": {
    ...
    "buttons": {
      "next": "Suivant",
      "back": "Retour",
      "startUsing": "Commencer à utiliser MODULY"
    }
  },
  "battery": {
    "title": "Batterie",
