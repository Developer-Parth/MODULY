...
export const APP_REGISTRY: Record<string, AppMetadata> = {
    ...
    browser: {
        ...
        icon: Globe,
        iconColor: 'from-cyan-400 to-green-500',
        iconSolid: '#00d4ff',
        category: 'utilities',
        isCore: true,
        component: Browser,
    ...
    terminal: {
        ...
        icon: Terminal,
        iconColor: 'from-zinc-900 to-orange-700',
        iconSolid: '#1f1609',
    ...
    notepad: {
        ...
        icon: FileText,
        iconColor: 'from-amber-300 to-orange-500',
        iconSolid: '#f59e0b',
        category: 'productivity',
        isCore: false,
        component: Notepad,
    ...
    messages: {
        ...
        icon: MessageSquare,
        iconColor: 'from-lime-400 to-green-600',
        iconSolid: '#22c55e',
        category: 'productivity',
        isCore: false,
        component: Messages,
    ...
    music: {
        ...
        icon: Music,
        iconColor: 'from-violet-500 to-cyan-500',
        iconSolid: '#8b5cf6',
        category: 'media',
        isCore: false,
        component: MusicApp,
    ...
    'dev-center': {
        ...
        icon: Code,
        iconColor: 'from-orange-600 to-fuchsia-600',
        iconSolid: '#f97316',
        category: 'development',
        isCore: false,
        component: DevCenter,
