...
// import photo6 from '@/assets/images/wallpaper-moduly.avif';
*/
    ...
    if (withMockFiles) {
        ...
        if (pictures) {
            pictures.children.push(
                ...
                //{ name: 'MODULY.jpg', type: 'file', content: photo6, size: 400187, owner: username, permissions: '-rw-r--r--' },
    ...
    children: [
        ...
        // System configuration files
        {
            ...
            children: [
                ...
                { name: 'hostname', type: 'file', permissions: '-rw-r--r--', owner: 'root', content: 'moduly' },
