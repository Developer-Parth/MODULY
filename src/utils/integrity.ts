...
// Critical Constants - Hashed identity values of this private hackathon build.
// Modifying these values in package.json without a dev key will trigger Safe Mode.
const EXPECTED_IDENTITY = {
    name: 2947666972, // Hash of 'moduly'
    author: 954693143, // Hash of 'MODULY Hackathon Build'
...
// Hash of the secret password "moduly-r00t-override"
// We store the hash so the actual password isn't easily greppable in the source.
export const DEV_KEY_HASH = 2078829038; // Hash of "moduly-r00t-override"
const STORAGE_KEY = 'MODULY_DEV_OVERRIDE';
