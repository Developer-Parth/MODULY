 ...
 * Website Registry
 *
 * Central registry of all fake websites available in MODULY Browser.
 * Add new websites here to make them accessible via the browser.
 */

import { Website } from './types';
import { WelcomePage } from './sites/WelcomePage';
import { ModulyInstitute } from './sites/ModulyInstitute';
...
export const websites: Website[] = [
  ...
  },
  {
    id: 'moduly-institute',
    domain: 'moduly.edu',
    name: 'MODULY Institute',
    description: 'Premier educational institution for technology and sciences',
    category: 'university',
    security: 'secure',
    color: '#1e3a8a',
    component: ModulyInstitute,
    searchable: true,
    keywords: ['university', 'education', 'college', 'student', 'courses', 'moduly'],
    aliases: ['www.moduly.edu', 'portal.moduly.edu'],
  },
  {
    id: 'techblog',
    domain: 'techblog.com',
