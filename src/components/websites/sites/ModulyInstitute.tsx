/**
 * MODULY Institute - Fake university website
...
export function ModulyInstitute(_props: WebsiteProps) {
    ...
    <WebsiteLayout bg="bg-white">
      <WebsiteHeader
        ...
        logo={
          <div className="flex items-center gap-2 text-white">
            ...
            <div>
              <div className="font-bold text-lg">MODULY Institute</div>
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">MODULY Institute</p>
              </div>
            </div>
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  placeholder="student@moduly.edu"
      ...
      <WebsiteContainer>
        ...
        <div className="grid grid-cols-2 gap-6 mb-12">
          {[
            {
              title: 'MODULY Institute Ranks Top 50 in Computer Science',
              date: 'January 3, 2026',
              image: 'bg-blue-100',
            },
            {
        ...
        <div className="grid grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div>Meme City, AC 12345</div>
              <div>info@moduly.edu</div>
              <div>(555) 123-4567</div>
            </div>
          </div>
        </div>
        <div className="pt-6 border-t border-gray-300 text-sm text-gray-600 text-center">
          © 2026 MODULY Institute. All rights reserved.
        </div>
      </WebsiteFooter>
    </WebsiteLayout>
  );
