...
const articles: Article[] = [
  {
    ...
    readTime: '1 min read',
    links: [
      { label: 'Open Build Notes', url: '#', variant: 'primary', icon: Download },
      { label: 'View Build Notes', url: '#', variant: 'default', icon: Star },
    ],
    content: `
      <div class="space-y-6">
        ...
        <p class="text-gray-600 leading-relaxed">
          MODULY is for everyone. We have achieved <strong>100% translation parity</strong> across all 12 supported languages. Whether you're using the system in English, German, Romanian, or Japanese, every UI element—from the Bios settings to the DevCenter—is now fully localized.
        </p>
  ...
  },
  {
    ...
    readTime: '2 min read',
    links: [
      { label: 'View Build Notes', url: '#', variant: 'primary', icon: Star },
      { label: 'Join Discord', url: 'https://discord.gg/AtAVfRDYhG', variant: 'default', icon: MessageCircle }
    ],
    content: `
      <div class="space-y-6">
        <p class="text-xl text-gray-600 leading-relaxed font-light">
          We are incredibly humbled to announce that <strong>MODULY</strong> has reached 400 stars on GitHub.
        </p>
    ...
    <WebsiteLayout bg="bg-gray-50">
        ...
        <div className="bg-linear-to-r from-indigo-600 to-purple-600 rounded-2xl p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 mb-8 max-w-md mx-auto text-lg">
              Connect with other developers, share your rices, and get direct support from the MODULY team.
            </p>
            <a
      ...
      <WebsiteFooter>
        ...
        <div className="pt-6 border-t border-gray-300 text-sm text-gray-600 text-center">
          ©2026 TechBlog. A MODULY sponsored news outlet.
        </div>
      </WebsiteFooter>
