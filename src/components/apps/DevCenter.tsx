...
export function DevCenter() {
    ...
    const handleExportStorage = () => {
        try {
            ...
            a.href = url;
            a.download = `moduly-prefs-${new Date().toISOString().slice(0, 10)}.json`;
                        ...
                        <div className="flex-1 overflow-hidden flex gap-4">
                            ...
                            <div className="flex-1 flex flex-col overflow-hidden border border-white/10 rounded-lg bg-black/20">
                                <div className="p-2 border-b border-white/10 bg-white/5 flex items-center gap-2">
                                    ...
                                    <span className="text-xs text-white/30 ml-2 font-mono">root@moduly-os:~</span>
                                </div>
                    ...
                    <div className="h-full overflow-y-auto p-6">
                        ...
                        <section className="mb-8">
                            ...
                            <div className="flex gap-4 flex-wrap">
                                ...
                                <GlassButton onClick={() => notify.app('com.moduly.devcenter', activeUser, 'App Notification', 'This is a test notification from DevCenter.')}>{t('devCenter.ui.buttons.app')}</GlassButton>
                            </div>
                        </section>
                        <section>
